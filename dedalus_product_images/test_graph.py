...
from dedalus_product_images.product_images_graph import ProductImagesState, compile_graph
...
async def main() -> None:
    ...
    # Image model for local FluxAdapter (same as original)
    ...
    print("Invoking graph (this will call LLM and FluxAdapter locally)...")
    try:
